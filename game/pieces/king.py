...
class King(piece.Piece):
    ...
    def get_moves(self, game_state):
        ...
        # Standard moves
        moves.append(self.standard_moves(game_state))

        # Castling
        moves.append(self.castle_moves(game_state))
    ...
    def standard_moves(self, game_state):
        ...
        moves = []
        for direction_index in range(self.direction_indexes):
